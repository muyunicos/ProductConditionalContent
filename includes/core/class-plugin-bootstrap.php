...
final class GDM_Plugin_Init {
    ...
    private function __construct() {        
        ...
        add_filter('gdm_has_rules', [$this, 'default_has_rules'], 10, 2);
        add_filter('gdm_has_custom_fields', [$this, 'default_has_fields'], 10, 2);
    ...
    public function default_has_rules($has, $item_id) {
        $rules = get_post_meta($item_id, '_gdm_rules', true);
        return !empty($rules);
    }

    public function default_has_fields($has, $item_id) {
        $fields = get_post_meta($item_id, '_gdm_fields', true);
        return !empty($fields);
    }
